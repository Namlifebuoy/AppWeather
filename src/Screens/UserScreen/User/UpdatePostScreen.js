...
const UpdatePost = () => {
  ...
  const [img, setImg] = useState([...route.params.item.media]);
  const [txt, setTxt] = useState(route.params.item.content);
    ...
    if (txt == null || txt == undefined || txt == '') {
      ...
      firestore()
        ...
        .update({
          ...
          location: {
            ...
            district: districtSelect.district_name
              ...
              : provinceSelect.district,
            ward: wardSelect.ward_name ? wardSelect.ward_name : wardSelect.ward,
          },
        ...
        .then(() => {
          ...
          Alert.alert('Bài viết đã được cập nhập !', '', [
            { text: 'Ok', onPress: () => navigation.goBack() },
          ]);
        })
        .catch(er => {
          Alert.alert(
            'Cập nhập bài viết thất bại',
  ...
  const handleHidePost = () => {
    Alert.alert('', 'Bạn có muốn xoá bài viết này không', [
      {
        text: 'Quay lại'
      },
      {
        ...
        <SafeAreaView style={styles.container}>
          ...
          <ScrollView>
            ...
            <TouchableOpacity onPress={handleHidePost}
              style={styles.btHidePost}
            >
              <Text style={styles.txtHidePost} >Xoá bài viết</Text>
            </TouchableOpacity>
